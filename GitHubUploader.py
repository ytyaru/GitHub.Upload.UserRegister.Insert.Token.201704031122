...
#        repo = web.service.github.api.v3.CurrentRepository.CurrentRepository(db, args.path_dir_pj, params={'description': args.description, 'homepage': args.homepage})
...
#        main = cui.uploader.Main.Main(db, client)
        main.Run()
